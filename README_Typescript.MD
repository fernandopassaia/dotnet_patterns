...
To use CODERUNNER and click on "RUN" to compile and run a file:
npm i ts-node -D (this will enable code-runner and a easy way to compile and run my TS files - see IMG)
