// eu implemento uma classe abstrata quando eu quero que todas classes pertencam a um subtipo
// e além disso quando eu quiser que as classes filhas implementem métodos (tenham comportamento) da pai
